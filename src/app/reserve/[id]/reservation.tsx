...
interface ReservationInfoProps {
  ...
  place?: Place;
  payload?: Payload;
  reservationMembers: Number | undefined;
        ...
        <div className="container mx-auto max-w-4xl px-4 py-8">
          <div className="overflow-hidden rounded-xl bg-white shadow-lg">
            ...
            <div className="p-6">
                  ...
                  <div className="rounded-lg bg-gray-50 p-4">
                    ...
                    <div className="flex items-center">
                      <span className="text-main text-xl font-bold">
                        {reservationMembers
                          ? `${reservationMembers}/${reservation.max_players}`
              ...
              {payload ? (
                payload.id != reservation.user_id ? (
                  isUserParticipant ? (
                    <button
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleCopy(
                        `${window.location.origin}/session/${reservation.id}`,
                      )
                    }
                  >
